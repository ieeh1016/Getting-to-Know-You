        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              _AlagagiHeroVisualMark(icon: icon),
            ],
          ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Icon(stat.icon, size: 13, color: const Color(0xFFF8EABD)),
            ),
            const Spacer(),
            Text(
              stat.value,
...
class _AlagagiHeroVisualMark extends StatelessWidget {
  const _AlagagiHeroVisualMark({required this.icon});
        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              alignment: Alignment.center,
              child: Icon(icon, size: 21, color: const Color(0xFFFEF9E7)),
            ),
          ),
        ],
      ),
...
class AlagagiBrandLeafMark extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final avatarSize = size * 0.37;
    final bridgeSize = size * 0.36;
    return SizedBox(
      width: size,
      height: size,
      child: Stack(
...
class _AlagagiBrandAvatarDot extends StatelessWidget {
  const _AlagagiBrandAvatarDot({required this.size, required this.color});
...
class AlagagiSymbolMark extends StatelessWidget {
  const AlagagiSymbolMark({
    super.key,
    required this.icon,
    this.size = 40,
    this.iconSize = 19,
    this.tone = AlagagiColors.skySoft,
    this.iconColor = AlagagiColors.sky,
    this.radius = 14,
    this.selected = false,
    this.muted = false,
  });
  ...
  @override
  Widget build(BuildContext context) {
    final softenedTone = Color.lerp(tone, Colors.white, 0.44) ?? tone;
    final markBorder = muted
        ? AlagagiColors.line
        : selected
        ? AlagagiColors.sky
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFFFDFAEF),
                shape: BoxShape.circle,
                border: Border.all(color: const Color(0xCCFFFEFA)),
              ),
              alignment: Alignment.center,
              child: const Icon(
                Icons.favorite_rounded,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        color: color,
        border: Border.all(color: AlagagiColors.paper, width: 2),
        boxShadow: const [
          BoxShadow(
            color: Color(0x177A5B14),
            blurRadius: 10,
            offset: Offset(0, 5),
          ),
        ],
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0x55DDB95E)),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: leaf ? const Color(0x55DDB95E) : AlagagiColors.line,
        ),
        borderRadius: BorderRadius.circular(20),
      ),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: dark ? null : Border.all(color: const Color(0x66DDB95E)),
        borderRadius: BorderRadius.circular(20),
      ),
      ...
      child: Text(
        ...
        style: sans(
          size: 10.5,
          weight: FontWeight.w800,
          color: dark ? Colors.white : const Color(0xFF796935),
        ),
      ),
    );
  }
...
class AlagagiQuietMetric extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: muted ? const Color(0xFFFFFCF5) : AlagagiColors.skyPanel,
        border: Border.all(
          color: muted ? AlagagiColors.line : const Color(0x66DDB95E),
        ),
        borderRadius: BorderRadius.circular(14),
      ),
        ...
        children: [
          ...
          Text(
            ...
            style: serif(
              ...
              size: 19,
              weight: FontWeight.w800,
              color: muted ? AlagagiColors.muted : const Color(0xFF796935),
            ),
          ),
        ],
      ),
