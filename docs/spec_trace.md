...
| `Q-CATALOG-001` | Daily question catalog holds 58 sequential prompts written for an early relationship and avoids long-term pressure language. | `docs/spec/questions.md` | Unit Tests | `test/src/domain/alagagi_controller_test.dart`: `daily question catalog provides 58 stable sequential questions`; `daily question catalog avoids long-term pressure language` |
