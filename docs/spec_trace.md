...
| `Q-CATALOG-002` | Days before the catalog cutover keep their original question id and text so saved answers stay paired with the question that was asked. | `docs/spec/questions.md` | Unit Tests | `test/src/domain/alagagi_controller_test.dart`: `answered days keep their original question id and text` |
