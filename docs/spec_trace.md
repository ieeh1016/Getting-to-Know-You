...
| `MEMORY-003` | Memory card title/body limits are 80/1000 and long bodies clamp to a readable-detail cue in the list. | `docs/spec/memory_cards.md`, `docs/spec/firestore.md` | Widget Tests | `test/src/ui/alagagi_app_test.dart`: `memory card long body clamps and opens the readable detail sheet` |
